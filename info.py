...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL','-1001779351808 -1002837453220'))
#-------------------------------------------------------------------------
AUTH_CHANNELS = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNELS', '-1002711457783 -1002600403677 -1002711023604').split()]
